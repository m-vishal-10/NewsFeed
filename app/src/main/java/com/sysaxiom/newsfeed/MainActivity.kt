...
@Composable
fun HomeScreen(newsData: StateFlow<List<Welcome>>) {
    ...
    Column(
        ...
        Column {
            ...
            OutlinedTextField(
                ...
                modifier = Modifier
                    .padding(10.dp),
                onValueChange = {  },
                label = { Text("Number1", color = Color.Black) },
        ...
        LazyColumn(
            ...
            items(newsDataState.size) {
                newsDataState.forEach { welcome ->
                    welcome.articles.forEach { article ->
                        NewsCard(
